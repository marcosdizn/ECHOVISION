...
void setup() {
  ...
  config.pixel_format = PIXFORMAT_GRAYSCALE; //GRAYSCALE;    // Options =  YUV422, GRAYSCALE, RGB565, JPEG, RGB888
...
void capturePhoto() {
  ...
  size_t jpeg_size = 0;
  bool converted = frame2jpg(fb, 60, &fb_jpeg, &jpeg_size);
  if(!converted){
